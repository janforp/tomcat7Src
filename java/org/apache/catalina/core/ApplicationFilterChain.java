...
/**
 * Implementation of <code>javax.servlet.FilterChain</code> used to manage the execution of a set of filters for a particular request.  When
 * the set of defined filters has all been executed, the next call to
...
final class ApplicationFilterChain implements FilterChain, CometFilterChain {
     ...
     */
    private int theCurrentFilterPositionNumber = 0;


    /**
     * The int which gives the current number of filters in the chain.
     */
    private int totalFilterNum = 0;
    ...
    /**
     * Invoke the next filter in this chain, passing the specified request and response.  If there are no more filters in this chain, invoke
    ...
    private void internalDoFilter(ServletRequest request, ServletResponse response) throws IOException, ServletException {
        ...
        if (theCurrentFilterPositionNumber < totalFilterNum) {
            ApplicationFilterConfig filterConfig = filters[theCurrentFilterPositionNumber++];
            Filter filter = null;
            try {
    ...
    void addFilter(ApplicationFilterConfig filterConfig) {
        ...
        //扩容
        if (totalFilterNum == filters.length) {
            ApplicationFilterConfig[] newFilters = new ApplicationFilterConfig[totalFilterNum + INCREMENT];
            System.arraycopy(filters, 0, newFilters, 0, totalFilterNum);
            filters = newFilters;
        }
        filters[totalFilterNum++] = filterConfig;
    ...
    void release() {
        ...
        totalFilterNum = 0;
        theCurrentFilterPositionNumber = 0;
        servlet = null;
        support = null;
